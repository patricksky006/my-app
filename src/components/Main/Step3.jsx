        ...
        <form action='' className='paying-container'>
          <div className='payment-wrapper'>
            <div className='pay-part a-part'>
              <label htmlFor='input-card-name' className='card-name'>
                持卡人姓名
              </label>
              <input
                type='text'
            ...
            <div className='pay-part b-part'>
              <label htmlFor='input-card-number' className='card-number'>
                卡號
              </label>
              <input
                type='text'
                className='input-card-number'
                placeholder='請輸入卡號 1111 2222 3333 4444'
              />
            </div>
            <div className='pay-part c-part'>
              <label htmlFor='input-expired-date' className='expired-date'>
                有效期限
              </label>
              <input
                type='text'
            ...
            <div className='pay-part d-part'>
              <label htmlFor='input-cvc-ccv' className='cvc-ccv'>
                CVC/CCV
              </label>
